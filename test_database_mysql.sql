-- MySQL Test Database Setup for Data Analyst AI Agent
-- This creates a sample sales database for testing the SQL integration

-- Create database
CREATE DATABASE IF NOT EXISTS sales_test_db;
USE sales_test_db;
...
-- GRANT SELECT ON sales_test_db.* TO 'your_username'@'localhost';
-- FLUSH PRIVILEGES;
